...
@Autonomous(name = "Red9RR")
public class Red9RR extends LinearOpMode {

    double ON = -1;
    double OFF = 0;
    double IN = 0.15;
    double NEARVEL = 1100; //(tune)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Vector2d shootPos = new Vector2d(82, 16);
        ...
        //------------------------------intake POSITION #1----------------
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(82, 16, Math.toRadians(-47)))
                        .strafeToLinearHeading(new Vector2d(79, 25), Math.toRadians(88))
                        .strafeToLinearHeading(new Vector2d(79, 42), Math.toRadians(88), new TranslationalVelConstraint(60))
        ...
        // ------------shoot #2-------------
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(79, 42, Math.toRadians(88)))
                        .strafeToLinearHeading(shootPos, Math.toRadians(-55), new TranslationalVelConstraint(60))
                        .build()
        );
        ...
        shoot();
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(82, 16, Math.toRadians(-55)))
                        .strafeToLinearHeading(new Vector2d(100, 25), Math.toRadians(91))
                        .strafeToLinearHeading(new Vector2d(100, 43), Math.toRadians(91), new TranslationalVelConstraint(60))
                        //.waitSeconds(0.2)
        ...
        intake.setPower(-0.1);
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(100, 43, Math.toRadians(91)))
                        .strafeToLinearHeading(shootPos, Math.toRadians(-55), new TranslationalVelConstraint(60))
                        .build()
        );
